...
// PERBAIKAN: Import CSS utama saja (Ini sudah Material Skin by default di versi baru)
...
const GanttView = ({ board }) => {
  ...
  useEffect(() => {
    if (ganttContainer.current) {
      ...
      // =========================================================
      // KONFIGURASI TEMA (CSS INJECTION)
      // =========================================================
