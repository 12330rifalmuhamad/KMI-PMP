        ...
        {activeTab === 'updates' && (
          <div className='flex-1 overflow-y-auto p-4 space-y-4'>
            <Card className='p-3 bg-transparent border border-divider'>
              <Typography variant='body2' className='mb-2'>Write an update and mention others with @</Typography>
              <TextField
                multiline
                minRows={3}
                fullWidth
            ...
            {updates.length === 0 ? (
              <Box className='flex flex-col items-center justify-center py-16 text-center'>
                ...
                <Typography variant='h6' className='mt-3'>No updates yet</Typography>
                <Typography className='text-textSecondary'>Share progress, mention a teammate, or upload a file to get things moving</Typography>
              </Box>
            ) : (
