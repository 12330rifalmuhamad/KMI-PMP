...
export default function ItemDetailPanel({ item, board, onClose }) {
  ...
  return (
    <div className='fixed top-0 right-0 h-full w-full md:w-1/3 bg-gray-800 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out translate-x-0'>
        ...
        <CardContent className='flex-1 overflow-y-auto'>
          ...
          <div className='space-y-6'>
            {updates?.map((update, index) => (
              ...
              >
                <Avatar>{update.user.name.charAt(0)}</Avatar>
