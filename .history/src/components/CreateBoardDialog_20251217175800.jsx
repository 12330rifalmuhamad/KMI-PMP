...
import useSWR from 'swr' // Pastikan install swr: npm install swr
    ...
    try {
      const res = await fetch('/api/boards', {
        ...
        body: JSON.stringify({
          ...
          templateId: selectedTemplate || null // Kirim ID jika ada
        })
      })
      ...
      // Callback ke parent untuk refresh list board / redirect
