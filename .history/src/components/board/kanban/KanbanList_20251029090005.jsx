...
const KanbanList = props => {
  ...
  return (
    <div
      ref={tasksListRef}
      className={`flex flex-col is-[16.5rem] kanban-column-draggable h-full transition-all duration-200 ${
      ...
      onDrop={e => {
        ...
        console.log('Drop detected in column:', column.id, 'taskId:', taskId)
