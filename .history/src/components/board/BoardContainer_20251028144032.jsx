      ...
      <Box className='px-6 pt-4 border-b border-divider'>
        ...
        <div className='flex justify-between items-center mb-4'>
          ...
          <div className='flex items-center gap-4 text-textSecondary'>
            ...
            {/* Menu aksi board */}
            <IconButton size='small' color='secondary' onClick={openMenu} aria-controls='board-menu' aria-haspopup='true'>
        ...
        <div className='flex items-center gap-3 py-3'>
          <Button
            ...
            onClick={() => openModal('CREATE_ITEM')} // Misalnya, modal untuk item baru
