...
const ValueEditorPopover = ({ anchorEl, onClose, column, board, onValueSelect }) => {
  ...
  // --- FUNGSI BARU UNTUK DELETE LABEL ---
  ...
  const handleSaveLabels = async () => {
    ...
    initialOptions.forEach(originalOpt => {
      // Cek apakah opsi asli masih ada di daftar baru (belum dihapus)
    ...
    // Opsi yang dikirim ke backend hanya yang tersisa di state `labels`
              ...
              {labels.map(option => (
                <TextField
                  ...
                  InputProps={{
                    ...
                    // --- BAGIAN TOMBOL DELETE DITAMBAHKAN DI SINI ---
                    endAdornment: (
