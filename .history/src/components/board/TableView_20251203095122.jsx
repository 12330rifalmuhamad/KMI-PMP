...
// =================================================================
// KOMPONEN PENDUKUNG (Avatar, Cells, Popovers)
// =================================================================
    ...
    setColumnSettings(prev => {
      ...
      if (newSettings[columnId]) {
        newSettings[columnId] = {
          ...newSettings[columnId],
          selected: !newSettings[columnId].selected
        }
      }
...
// =================================================================
// KOMPONEN BARU: ColumnVisibilityPopover
// =================================================================
...
export default function TableView({ board }) {
  ...
  // STATE BARU: Untuk melacak kolom yang di-hide
  const [hiddenColumnIds, setHiddenColumnIds] = useState([])

  // STATE BARU: Untuk menu toggle visibility
  ...
  // LOGIC BARU: Filter kolom yang akan dirender
