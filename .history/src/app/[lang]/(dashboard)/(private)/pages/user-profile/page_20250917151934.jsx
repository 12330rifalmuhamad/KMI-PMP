...
// Component Imports
import UserProfile from '@/views/pagesll/user-profile'

// Data Imports
import { getProfileData } from '@/app/server/actions'

const ProfileTab = dynamic(() => import('@/views/pagesll/user-profile/profile'))
const TeamsTab = dynamic(() => import('@/views/pagesll/user-profile/teams'))
const ProjectsTab = dynamic(() => import('@/views/pagesll/user-profile/projects'))
const ConnectionsTab = dynamic(() => import('@/views/pagesll/user-profile/connections'))
