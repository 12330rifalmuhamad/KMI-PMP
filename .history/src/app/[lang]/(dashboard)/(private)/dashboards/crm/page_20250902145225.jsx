...
// ====================================================================
// PERBAIKAN: Gunakan path alias '@/' yang menunjuk ke folder 'src'
// ====================================================================
...
async function getBoards(workspaceId) {
  try {
    // Gunakan environment variable untuk URL absolut, ini lebih aman
    const apiUrl = `${process.env.NEXTAUTH_URL}/api/workspaces/${workspaceId}/boards`
...
const CrmDashboardPage = async () => {
  ...
  const boards = await getBoards(1) // Hardcode workspaceId 1 untuk contoh
