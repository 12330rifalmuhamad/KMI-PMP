...
const UserProfilePage = () => {
        ...
        return (
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <Grid container spacing={4}>
                  <Grid item xs={12} md={4}>
                    <Box className='flex flex-col items-center space-y-4'>
                      <Avatar src={profileImage} alt={session?.user?.name || 'User'} className='w-24 h-24 bg-gray-600' />
                      <Box className='flex flex-col items-center space-y-2'>
                        ...
                        <label htmlFor='profile-image-upload'>
                          <Button variant='outlined' component='span' size='small' className='text-white border-gray-500 hover:border-gray-400'>
                  ...
                  <Grid item xs={12} md={8}>
                    <Box className='space-y-4'>
                      ...
                      <Chip label='Guest' className='bg-blue-600 text-white' size='small' />
                    </Box>
                  </Grid>
                </Grid>
              </CardContent>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Email</Typography>
                        <Controller
                          name='email'
                          control={control}
                          rules={{
                  ...
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Phone</Typography>
                        <Controller
                          name='phone'
                          control={control}
                          render={({ field }) => (
                  ...
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Mobile phone</Typography>
                        <CustomTextField
                  ...
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Location</Typography>
                        <Controller
                          name='location'
                          control={control}
                          render={({ field }) => (
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Birthday</Typography>
                        <Controller
                          name='birthday'
                          control={control}
                          render={({ field }) => (
                  ...
                  <Grid item xs={12} md={6}>
                    <Box className='flex items-center space-x-3'>
                      ...
                      <Box>
                        <Typography variant='body2' className='text-gray-400'>Work anniversary</Typography>
                        <Controller
            ...
            <Box className='flex justify-end space-x-2 pt-4'>
              <Button variant='outlined' onClick={() => reset()} disabled={loading} className='text-white border-gray-500 hover:border-gray-400'>
                Reset
              </Button>
              <Button
                type='submit'
  ...
  return (
    <Box className='min-h-screen bg-gray-900'>
      {/* Notification Banner */}
      <Box className='bg-blue-600 text-white p-3 flex items-center justify-center space-x-4'>
        <Typography variant='body2'>
          Enable desktop notifications on this computer
        </Typography>
        <Button variant='contained' size='small' className='bg-blue-500 hover:bg-blue-400'>
          Enable now
        </Button>
          ...
          <List className='space-y-2'>
            {navigationItems.map((item) => (
              ...
              >
                ...
                <ListItemText
                  primary={item.label}
                  className={activeTab === item.id ? 'text-white' : 'text-gray-300'}
                />
              </ListItem>
            ))}
          </List>
